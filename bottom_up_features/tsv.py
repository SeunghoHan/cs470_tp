...
train2014_path = '/archive/MyHome/Programs/git/my_research/dataset/coco_2014/train2014'
val2014_path = '/archive/MyHome/Programs/git/my_research/dataset/coco_2014/val2014'
...
if __name__ == '__main__':
    ...
    if os.path.exists(train_ids_file) and os.path.exists(val_ids_file):
        ...
        train_imgids = feature_utilsㅌ.load_imageid(train2014_path)
